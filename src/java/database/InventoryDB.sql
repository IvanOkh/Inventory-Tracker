...
INSERT INTO `user_table` (`email`,`active`,`fname`,`lname`,`password`,`role`)
	VALUES ('ivan@gmail.com', true, 'Ivan','Okh','password',2);
INSERT INTO `user_table` (`email`,`active`,`fname`,`lname`,`password`,`role`)
	VALUES ('max@gmail.com', true, 'Max','Smith','password',2);

INSERT INTO `item_table` (`Category`,`ItemName`,`Price`,`Owner`) VALUES (1,'blender',29.99,'ivan@gmail.com');
INSERT INTO `item_table` (`Category`,`ItemName`,`Price`,`Owner`) VALUES (1,'toaster',19.99,'ivan@gmail.com');
INSERT INTO `item_table` (`Category`,`ItemName`,`Price`,`Owner`) VALUES (3,'lamp',5,'ivan@gmail.com');
INSERT INTO `item_table` (`Category`,`ItemName`,`Price`,`Owner`) VALUES (6,'winter tires',200,'ivan@gmail.com');
INSERT INTO `item_table` (`Category`,`ItemName`,`Price`,`Owner`) VALUES (5,'dresser',50,'ivan@gmail.com');
